                    ...
                    <div class="col-lg-7">
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <form id="signUpForm" method="post" enctype="multipart/form-data" action="{{ url('apply/store') }}"> @csrf
                                ...
                                <div class="step">
                                    <div class="mb-3">
                                        <select id="mySelect" class="form-select select-input"  name="program_id" required>
                                            <option value="default" selected>Choose Your Program</option>
                                        ...
                                        <textarea class="select-input" id="description" rows="5" cols="57" readonly></textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <select class="form-select select-input"  name="district_id" required>
    ...
    var currentTab = 0; // Current tab is set to be the first tab (0)
        ...
        function validateForm() {
            ...
            for (i = 0; i < y.length; i++) {
                // If a field is empty...
                if ((y[i].value == "" && y[i].name !== "employment" && y[i].name !== "position") 
    ...
    <script>
        ...
        select.addEventListener("change", function(){
            ...
            for (var i = 0; i < programs.length; i++) {
                if(select.value == programs[i].id){
                    description.value = programs[i].requirement;
                    break;
                } else {
                    description.value = "";
                }
