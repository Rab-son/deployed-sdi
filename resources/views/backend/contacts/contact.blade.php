                ...
                <div class="card mb-3">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th style="text-align: center; text-transform: capitalize">Subject</th>
                        <th style="text-align: center; text-transform: capitalize">Message</th>
                    ...
                    <?php $i++; ?>
                      <tr class="gradeX">
                        ...
                        <td style="text-align: center; text-transform: capitalize;"> {{ $form->subject }}</td>
                        <td style="text-align: center; text-transform: capitalize;"> {{ $form->message }}</td>
                    ...
                    <div class="modal fade" id="Modal2{{$form->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="{{ url('/contact-us/delete/'.$form->id ) }}" class="btn btn-danger">Delete</a>
                        </div>
                        </div>
                        </div>
                    </div>
