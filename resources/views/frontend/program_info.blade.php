                        ...
                        <div class="col-12 text-center">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    ...
                                    <li class="breadcrumb-item text-white active" aria-current="page">{{ $programDetails->name }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="container-xxl py-5">
            <div class="container py-5 px-lg-5">
                <div class="wow fadeInUp" data-wow-delay="0.1s">
                    <p class="section-title text-secondary justify-content-center"><span></span>Our Programs<span></span></p>
                    <h1 class="text-center mb-5">{{ $programDetails->name }}</h1>
                </div>
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item d-flex flex-column text-center rounded">
                            ...
                            <h5 class="mb-3">{{ $programDetails->name }}</h5>
                        </div><br>
                    </div>
                    <div class="col-lg-8 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="bg-light p-4">
                            <p class="m-0">
                                ...
                                {{ $programDetails->introduction }}
                            </p>
                            <p class="m-0">
                                <h4>Target Audience</h4>
                                {{ $programDetails->audience }}
                            </p>
                            <p class="m-0">
                                <h4>Requirements</h4>
                                {{ $programDetails->requirement }}
                            </p>
                            <p class="m-0">
                                <div class="d-flex justify-content-center">
                                    <a href="{{ url('/training/details/'.$programDetails->id)}}" class="btn btn-secondary py-sm-3 px-sm-5 rounded-pill me-3 animated slideInLeft">Apply Now</a>
                                </div>
                             </p>
                        </div>
                    </div>
