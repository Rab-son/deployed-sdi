    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Programs
                    <div class="page-title-subheading">Manage Programs</div>
                </div>
            </div>
        </div>
                ...
                <div class="card mb-3">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th style="text-align: center; text-transform: capitalize">Introduction</th>
                        <th style="text-align: center; text-transform: capitalize">Target Audience</th>
                        <th style="text-align: center; text-transform: capitalize">Requirements</th>
                    ...
                    @foreach ($programs as $form) 
                    <?php $i++; ?>
                      <tr class="gradeX">
                        <td style="text-align: center; text-transform: capitalize;"> {{ $form->name }}</td>
                        <td style="text-align: center; text-transform: capitalize;"> {{ $form->introduction }}</td>
                        <td style="text-align: center;">{{ $form->audience }}</td>
                        <td style="text-align: center;text-transform: capitalize;">{{ $form->requirement }}</td>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
    <div class="modal-header">
    <h5 class="modal-title" id="exampleModalLongTitle">Add Program Details</h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true">&times;</span>
    </button>
    </div>
    <form id="signupForm" enctype="multipart/form-data"  method="post" action="{{ url('/program-store') }}">{{ csrf_field() }}
    <div class="modal-body">
        <p>
            <div class="form-group">
                <label for="firstname">Name</label>
