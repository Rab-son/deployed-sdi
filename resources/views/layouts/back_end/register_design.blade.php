      ...
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg blur border-radius-lg top-0 z-index-3 shadow position-absolute mt-4 py-2 start-0 end-0 mx-4">
          <div class="container-fluid">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-primary" href="../pages/dashboard.html">
              SDI Dashboard | User Registration
            </a>
            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <li class="nav-item">
                  <a class="nav-link me-2" href="#">
                    <i class="fas fa-smile opacity-6 text-primary me-1"></i>
              ...
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="#" class="btn btn-sm mb-0 me-1 btn-primary">Terms and Conditions</a>
                </li>
              </ul>
            </div>
          </div>
