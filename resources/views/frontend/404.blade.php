            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="program.html" class="nav-item nav-link">Programmes</a>
                        <a href="apply.html" class="nav-item nav-link">Become A Member</a>
                    ...
                    <a href="donate.html" class="btn rounded-pill py-2 px-4 ms-3 d-none d-lg-block">Donate</a>
                </div>
            </nav>
